						...
						<div class="panel">
							...
							<div class="content">
								<ul style="list-style-type: none;">
									<li><input type="url"
										value="http://<%=InetAddress.getLocalHost().getCanonicalHostName()%>:<%=request.getLocalPort()%><%=this.getServletConfig().getServletContext().getContextPath()%>/AggregateViolationChangeReport?Aggregate=<%=request.getParameter("Aggregate")%>"
										size="54"></li>
