...
public class SonarReportConfigurationHandler {
	...
	private boolean update(HttpServletRequest req) {
		if (req.getParameter("KEE") != null) {
            ...
            properties.setProperty("DEFAULT_EMAIL_SENDER", req.getParameter("DEFAULT_EMAIL_SENDER"));
            ...
            //add email sender
            properties.setProperty(AggregateReportConstant.DEFAULT_EMAIL_SENDER,
                    req.getParameter(AggregateReportConstant.DEFAULT_EMAIL_SENDER));
